...
/** tabbar被点击的通知的名字 */
UIKIT_EXTERN NSString * const LSTabBarDidSelectNotification;
/** tabbar被点击的控制器的index */
UIKIT_EXTERN NSString * const LSSelectControllerIndexKey;
/** tabbar被点击的控制器的key */
UIKIT_EXTERN NSString * const LSSelectControllerKey;

/** 标签-间距*/
UIKIT_EXTERN CGFloat const LSTagMargin;
